...
function testEnvironment($envName, $envConfig, $username, $password, $retailerId) {
	...
	$testOrder = [
	    ...
	    'items' => [
	        [
	            'sku' => 'Rectangle_Vertical_Crystals-Rectangle_Medium_(8x5cm)-Face-Lightbase_Square-customer_text',
	            'client_item_id' => 'TEST-' . uniqid(),
	            'qty' => '1',
	            'original_photo' => 'https://api.cockpit3d.com/media/order_item/4/0/4/5/7/0/404570_6726d4a83b297.png',
	            'cropped_photo' => 'https://api.cockpit3d.com/media/order_item/4/0/4/5/7/0/404570_6726d4a83f555.png',
	            'special_instructions' => 'TEST ORDER - DO NOT PROCESS',
	            'options' => [
	                [
	                    'id' => '168',
	                    'qty' => '1',
	                    'value' => 'Rectangle Medium (8x5cm)'
	                ],
	                [
	                    'id' => '169',
	                    'qty' => '1',
	                    'value' => 'Lightbase Square'
	                ],
	                [
	                    'id' => '200',
	                    'qty' => '1',
...
foreach ($environments as $envKey => $envConfig) {
	...
	echo "<td>{$envConfig['url']}$cockpitLoginPath</td>";
	echo "<td>$status</td>";
	echo "</tr>";
}
echo "</table>";
