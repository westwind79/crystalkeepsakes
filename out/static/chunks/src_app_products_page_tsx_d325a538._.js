...
function ProductsPage() {
   ...
   */ const fetchProducts = async ()=>{
        try {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                console.log("✅ Loaded ".concat((cockpit3dProducts === null || cockpit3dProducts === void 0 ? void 0 : cockpit3dProducts.length) || 0, " products"));
            }
        } catch (err) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        var _data_products;
                        console.log("✅ Loaded ".concat(((_data_products = data.products) === null || _data_products === void 0 ? void 0 : _data_products.length) || 0, " products from API"));
                    }
                } else {
