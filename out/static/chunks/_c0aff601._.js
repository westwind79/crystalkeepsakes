...
// Version: 1.0.3 | Date: 2025-11-08
// Checkout using Next.js API route proxy (no CORS issues!)
...
;
;
const STRIPE_PUBLISHABLE = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_STRIPE_DEVELOPMENT_PUBLISHABLE_KEY;
...
function CheckoutPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CheckoutPage.useEffect": ()=>{
            ...
            // Fetch via Next.js API route (same origin - no CORS!)
            // This route will proxy to MAMP PHP backend
            fetch('/api/stripe/create-payment-intent.php', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    total: cart.reduce({
                        "CheckoutPage.useEffect": (sum, item)=>sum + item.price * (item.quantity || 1)
                    }["CheckoutPage.useEffect"], 0)
                })
            }).then({
                "CheckoutPage.useEffect": (res)=>{
                    console.log('📡 Response status:', res.status);
                    return res.text();
                }
            }["CheckoutPage.useEffect"]).then({
                "CheckoutPage.useEffect": (text)=>{
                    console.log('📥 Response text:', text.substring(0, 200));
                    try {
                        const data = JSON.parse(text);
                        if (data.success && data.clientSecret) {
                            console.log('✅ Payment intent created:', data.order_number);
...
_s1(CheckoutPage, "90MXg/odchrQ2PSRQMS7T+dZHaY=");
_c1 = CheckoutPage;
var _c, _c1;
...
//# sourceMappingURL=_c0aff601._.js.map