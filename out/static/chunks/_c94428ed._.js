...
;
// Get publishable key
const STRIPE_PUBLISHABLE_KEY = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "pk_test_51QoDYf2YE48VQlzYfIyha9s0umcxiWH6KBH2KCQY7eH4wTrVqrRG2f6YUJWnJ2i6fKxztn1unhlhUajMuTAzI7Ju000JqwCHwk");
let stripePromise = null;
const getStripe = ()=>{
    if (!stripePromise) {
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        stripePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stripe$2f$stripe$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadStripe"])(STRIPE_PUBLISHABLE_KEY);
        console.log('✅ Stripe initialized:', ("TURBOPACK compile-time value", "development"));
    }
 ...
 */ function getPhpEndpoint() {
    const mode = ("TURBOPACK compile-time value", "development") || 'development';
    if ("TURBOPACK compile-time truthy", 1) {
        const port = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_MAMP_PORT || '8888';
        return "http://localhost:".concat(port, "/crystalkeepsakes/api/stripe/create-payment-intent.php");
    }
    //TURBOPACK unreachable
    ;
}
async function createPaymentIntent(cartItems) {
    let shippingMethod = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'standard', fullCartItems = arguments.length > 2 ? arguments[2] : void 0, orderNumber = arguments.length > 3 ? arguments[3] : void 0, cockpitOrder = arguments.length > 4 ? arguments[4] : void 0;
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('creating intent', {
        orderNumber,
    ...
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('Order totals', totals);
        ...
        const requestBody = {
            ...
            orderNumber: orderNumber || "ORD-".concat(Date.now()),
        ...
        if (!response.ok) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Payment intent failed', {
                status: response.status,
                error: errorText
            });
            throw new Error("Payment intent creation failed: ".concat(response.status));
        }
        const data = await response.json();
        if (!data.success) {
            throw new Error(data.error || 'Payment intent creation failed');
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('intent created', {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Payment intent failed', error);
        throw error;
    }
}
async function confirmPayment(clientSecret, paymentMethod) {
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('confirming', {
        clientSecret
    });
    ...
    try {
        ...
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Payment confirmation failed', error);
            throw error;
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('confirmed', {
            id: paymentIntent === null || paymentIntent === void 0 ? void 0 : paymentIntent.id
        });
        return paymentIntent;
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Payment error', error);
        throw error;
    }
}
async function createCheckoutSession(cartItems, customerEmail) {
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('creating checkout session', {
        itemCount: cartItems.length,
        customerEmail
    });
    try {
        const endpoint = getPhpEndpoint();
        const orderNumber = "ORD-".concat(Date.now());
        const requestBody = {
            cartItems: cartItems.map((item)=>({
                    name: item.name,
                    sku: item.sku,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('Requesting checkout session', {
            endpoint,
            orderNumber
        });
        const response = await fetch(endpoint, {
        ...
        if (!response.ok) {
            const errorText = await response.text();
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Checkout session failed', {
                status: response.status,
                error: errorText
            });
            throw new Error("Checkout session creation failed: ".concat(response.status));
        }
        const data = await response.json();
        if (!data.success) {
            throw new Error(data.error || 'Checkout session creation failed');
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('Checkout session created', {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Checkout session creation failed', error);
        throw error;
    }
}
async function redirectToCheckout(sessionId) {
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('redirecting to checkout', {
        sessionId
    });
    const stripe = await getStripe();
    if (!stripe) {
    ...
    if (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Redirect failed', error);
        throw error;
    }
}
async function startCheckout(cartItems, customerEmail) {
    try {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].payment('starting checkout', {
            itemCount: cartItems.length
        });
        // Create checkout session
        const { sessionId, orderNumber } = await createCheckoutSession(cartItems, customerEmail);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Checkout failed', error);
        throw error;
    }
}
...
function calculateOrderTotals(cartItems) {
    let shippingMethod = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'standard';
...
function CheckoutForm(param) {
    let { clientSecret, orderTotals } = param;
    _s();
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if ((paymentIntent === null || paymentIntent === void 0 ? void 0 : paymentIntent.status) !== 'succeeded') throw new Error('Payment failed');
            setMessage('✅ Payment successful!');
            setTimeout(()=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cartUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearCart"])();
                window.location.href = '/order-confirmation?order=' + paymentIntent.id;
            }, 2000);
        } catch (err) {
            console.error('Payment error:', err);
            setMessage("❌ Error: ".concat(err.message));
            setProcessing(false);
        }
    }
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: orderTotals.shippingCost === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                lineNumber: 68,
                                                columnNumber: 19
                                            }, this) : "$".concat(orderTotals.shippingCost.toFixed(2))
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/checkout/page.tsx",
                                            lineNumber: 66,
                                            columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: processing ? 'Processing...' : "Pay $".concat(orderTotals.total.toFixed(2))
                        }, void 0, false, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 91,
                            columnNumber: 11
                        ...
                        message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4 p-3 rounded text-sm ".concat(message.includes('✅') ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'),
                            children: message
                        }, void 0, false, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 100,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Test: 4242 4242 4242 4242 | Any future date | Any CVC"
                        }, void 0, false, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 107,
                            columnNumber: 11
...
_s(CheckoutForm, "dEIIFm2PyhspHuq9jEqBfsh2J/4=", false, function() {
    return [
...
function CheckoutPage() {
    ...
    const [orderTotals, setOrderTotals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        subtotal: 0,
        shippingCost: 0,
        taxAmount: 0,
        total: 0
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CheckoutPage.useEffect": ()=>{
            const cartItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cartUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])();
            setCart(cartItems);
            if (cartItems.length > 0) {
                const totals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateOrderTotals"])(cartItems, shippingMethod);
        ...
        "CheckoutPage.useEffect": ()=>{
            async function initializePayment() {
                try {
                    ...
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPaymentIntent"])(cart, shippingMethod);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "font-bold",
                                                children: orderTotals.subtotal >= 100 ? 'FREE' : '$5.00'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/checkout/page.tsx",
                                                lineNumber: 210,
                                                columnNumber: 17
                            ...
                            orderTotals.subtotal >= 100 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-4 p-3 bg-green-50 text-green-800 rounded text-sm",
                                children: "🎉 You qualify for free standard shipping!"
                            }, void 0, false, {
                                fileName: "[project]/src/app/checkout/page.tsx",
                                lineNumber: 249,
                                columnNumber: 15
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stripe$2f$react$2d$stripe$2d$js$2f$dist$2f$react$2d$stripe$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Elements"], {
                stripe: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStripe"])(),
                options: {
                    clientSecret
                },
...
_s1(CheckoutPage, "M6oURm20FpIEWT1Z71zj6KGwGhE=");
_c1 = CheckoutPage;
var _c, _c1;
...
//# sourceMappingURL=_c94428ed._.js.map