...
// Complete checkout flow with Stripe Payment Intent and Cockpit3D integration
__turbopack_context__.s({
...
;
// Load Stripe
const STRIPE_PUBLISHABLE = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "pk_test_51QoDYf2YE48VQlzYfIyha9s0umcxiWH6KBH2KCQY7eH4wTrVqrRG2f6YUJWnJ2i6fKxztn1unhlhUajMuTAzI7Ju000JqwCHwk");
const stripePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stripe$2f$stripe$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadStripe"])(STRIPE_PUBLISHABLE);
// Checkout form component
function CheckoutForm(param) {
    let { clientSecret, orderNumber, orderTotals } = param;
    _s();
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if ((paymentIntent === null || paymentIntent === void 0 ? void 0 : paymentIntent.status) === 'succeeded') {
                ...
                setTimeout(()=>{
                    router.push("/order-confirmation?order=".concat(orderNumber));
                }, 1500);
            } else {
                throw new Error('Payment was not successful');
            }
        } catch (err) {
            setMessage("❌ ".concat(err.message || 'Payment failed'));
            setProcessing(false);
        }
    }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: "w-full mt-6 bg-[#8ac644] text-black py-3 px-4 rounded-lg font-bold    hover:bg-[#7ab534] disabled:bg-gray-400 disabled:cursor-not-allowed   transition-colors duration-200",
                            children: processing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                lineNumber: 130,
                                columnNumber: 15
                            }, this) : "Pay $".concat(orderTotals.total.toFixed(2))
                        }, void 0, false, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 122,
                            columnNumber: 11
                        ...
                        message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4 p-3 rounded-lg text-sm ".concat(message.includes('✅') ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'),
                            children: message
                        }, void 0, false, {
                            fileName: "[project]/src/app/checkout/page.tsx",
                            lineNumber: 143,
...
_s(CheckoutForm, "Klscn+9ImpsuKo2q6D8Xd3bW0U0=", false, function() {
    return [
...
function CheckoutPage() {
    ...
    async function initializeCheckout() {
        try {
            // Get cart
            const cartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cartUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])();
            ...
            const endpoint = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 'http://localhost/crystal-keepsakes/public/create-payment-intent.php';
            const response = await fetch(endpoint, {
                ...
                body: JSON.stringify({
                    ...
                    fullCartItems: cartData.items,
                    shippingMethod: shippingMethod,
                    orderNumber: "CK-".concat(Date.now(), "-").concat(Math.floor(Math.random() * 10000))
                })
            });
            if (!response.ok) {
                const errorText = await response.text();
                throw new Error("Payment intent creation failed: ".concat(errorText));
            }
            ...
            // Calculate totals (these should match backend calculations)
            ...
            const taxRate = 0.085 // 8.5% - adjust for your state
            ;
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-[#8ac644]"
                    }, void 0, false, {
                        fileName: "[project]/src/app/checkout/page.tsx",
                        lineNumber: 270,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Initializing secure checkout..."
                    }, void 0, false, {
                        fileName: "[project]/src/app/checkout/page.tsx",
                        lineNumber: 271,
                        columnNumber: 11
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                        href: "/cart",
                        className: "inline-block bg-[#8ac644] text-black px-6 py-2 rounded-lg font-bold hover:bg-[#7ab534]",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "max-w-2xl mx-auto mb-6 bg-white p-4 rounded-lg shadow-md",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "font-semibold",
                                            children: orderTotals.subtotal >= 100 ? 'FREE' : '$9.99'
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/checkout/page.tsx",
                                            lineNumber: 321,
                                            columnNumber: 15
...
_s1(CheckoutPage, "yfYyrdMe1Ac+REJrQOSwQO4s85A=");
_c1 = CheckoutPage;
var _c, _c1;
...
//# sourceMappingURL=_3a287feb._.js.map