...
// app/cart/page.tsx
// Version: 5.0.0 - 2025-11-11 - COMPLETE FIX
// ✅ Fixed: Product images now display correctly
// ✅ Fixed: Shows both raw uploaded and masked images
// ✅ Fixed: All options (background, size, etc.) display properly
// ✅ Fixed: Prices calculated correctly from base + options
__turbopack_context__.s({
    "default": ()=>CartPage
});
...
function CartPage() {
    ...
    // Load cart with proper image handling
    const loadCart = async ()=>{
        try {
            setLoading(true);
            // Try to get cart with images if function exists
            let cartData = [];
            try {
                // First try the enhanced version if available
                const { getCartWithImages } = await __turbopack_context__.r("[project]/src/lib/cartUtils.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
                cartData = await getCartWithImages();
            } catch  {
            ...
            cartData = cartData.map((item)=>({
                    ...
                    // Ensure proper size details
                    sizeDetails: item.sizeDetails || item.size,
                    // Parse options if needed
                    options: Array.isArray(item.options) ? item.options : item.options ? Object.entries(item.options).map(([key, value])=>({
                            category: key,
                            name: key,
                            value: value,
                            priceModifier: 0
            ...
            setCart(cartData);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].info('Cart loaded', {
                items: cartData.length,
                withImages: cartData.filter((item)=>item.customImage).length
            });
        } catch (error) {
    ...
    const handleRemoveItem = async (index)=>{
        setRemoving(index);
        try {
            const { removeFromCart } = await __turbopack_context__.r("[project]/src/lib/cartUtils.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    const handleClearCart = async ()=>{
        if (confirm('Are you sure you want to clear your entire cart?')) {
            try {
                const { clearCart } = await __turbopack_context__.r("[project]/src/lib/cartUtils.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
                await clearCart();
                setCart([]);
    ...
    const updateQuantity = async (index, newQuantity)=>{
        ...
        try {
            ...
            const optionsPrice = item.optionsPrice || 0;
            updatedCart[index].totalPrice = (basePrice + optionsPrice) * newQuantity;
            // Save to localStorage
            localStorage.setItem('cart', JSON.stringify(updatedCart));
            setCart(updatedCart);
            window.dispatchEvent(new Event('cartUpdated'));
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].error('Failed to update quantity', error);
        }
    };
    // Get display-friendly options
    const getDisplayOptions = (item)=>{
        const displayOptions = {};
        // Handle array format (new structure from ProductDetailClient)
        if (Array.isArray(item.options)) {
            item.options.forEach((opt)=>{
                if (opt.value && opt.value !== 'None') {
                    displayOptions[opt.name || opt.category] = {
                        value: opt.value,
        ...
        // Add size if present
        const size = item.sizeDetails || item.size;
        if (size?.sizeName) {
            displayOptions.Size = {
                value: size.sizeName,
                price: size.basePrice - (item.basePrice || 0)
            };
        }
        // Add custom text
        if (item.customText) {
            const text = typeof item.customText === 'string' ? item.customText : item.customText.text;
            if (text) {
                displayOptions['Custom Text'] = {
                    value: text,
                    price: 0
                };
            }
    ...
    const calculateSubtotal = ()=>{
        return cart.reduce((sum, item)=>{
            const itemTotal = (item.totalPrice || item.price || 0) * item.quantity;
    ...
    const getProductImage = (item)=>{
        ...
        // 1. Custom image (masked/edited)
        // 2. Raw uploaded image
        // 3. Product image from options
        // 4. Placeholder
        if (item.customImage?.dataUrl) {
            return item.customImage.dataUrl;
        }
        if (item.rawImageUrl) {
        ...
        // Try to get from IndexedDB if imageId exists
        // This would require async loading, simplified for now
        ...
        try {
            ...
            const orderData = {
                items: cart.map((item)=>({
                        ...
                        size: item.sizeDetails || item.size,
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: cart.map((item, index)=>{
                                ...
                                const itemPrice = item.totalPrice || item.price || item.basePrice || 0;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            item.customImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "absolute top-1 right-1 bg-green-500 text-white text-xs px-2 py-0.5 rounded",
                                                                children: "Customized"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/cart/page.tsx",
                                                                lineNumber: 388,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "text-xs text-gray-500 mb-3 space-y-0.5",
                                                            children: [
                                                                ...
                                                                item.cockpit3d_id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        "Product ID: ",
                                                                        item.cockpit3d_id
                                                                    ]
                                                        ...
                                                        Object.keys(displayOptions).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "mb-3 p-3 bg-gray-50 rounded-lg",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "text-sm space-y-1.5",
                                                                children: Object.entries(displayOptions).map(([key, opt])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        item.customImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "mb-3 p-2 bg-blue-50 rounded text-sm",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-blue-700 font-medium",
                                                                    children: "✓ Custom Image Applied"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/cart/page.tsx",
                                                                    lineNumber: 442,
                                                                    columnNumber: 29
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        " •",
                                                                        (item.customImage.fileSize / 1024).toFixed(1),
                                                                        "KB •",
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                        className: "px-3 py-1 border-x font-medium",
                ...
                ("TURBOPACK compile-time value", "development") === 'development' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("details", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                            className: "mt-2 text-xs overflow-auto bg-white p-4 rounded",
...
//# sourceMappingURL=_8c3f8da1._.js.map