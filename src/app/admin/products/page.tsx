                    ...
                    {activeTab === 'basic' && (
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-3">
                          <h4 className="text-sm font-bold text-gray-800">💰 Cost & Profit</h4>
                            ...
                            <div>
                              ...
                              <div className="text-lg font-bold text-green-600">
                                {selectedProductData.cost && selectedProductData.basePrice
                                  ? `$${(selectedProductData.basePrice - selectedProductData.cost).toFixed(2)} (${Math.round(((selectedProductData.basePrice - selectedProductData.cost) / selectedProductData.cost) * 100)}%)`
                                  : 'N/A'}
                              </div>
                            </div>
                          </div>
                        ...
                        {/* On Sale Section - Now with Percentage Option */}
                        <div className="space-y-3">
                          ...
                          {selectedProductData.sale && (
                            <div className="ml-6 p-4 bg-red-50 border border-red-200 rounded-lg space-y-4">
                                ...
                                <div>
                                  ...
                                  <div className="relative">
                                    <input
                                      ...
                                      placeholder="15"
                                      className="w-full pr-8 pl-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"
                                    />
                                    <span className="absolute right-3 top-2 text-gray-500">%</span>
                                  </div>
                                </div>

                                {/* Fixed Sale Price (Legacy) */}
                                <div>
                                  <label className="block text-sm font-medium text-gray-700 mb-1">
                                    Fixed Sale Price
                                  </label>
                              ...
                              <div className="pt-3 border-t border-red-200">
                                <div className="text-xs text-gray-700 space-y-1">
                                  <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold">${selectedProductData.basePrice?.toFixed(2) || '0.00'}</span>
                                  </div>
                                  {selectedProductData.salePercent && (
                                    <>
                                      <div className="flex justify-between text-green-700">
                                        <span>Sale Price ({selectedProductData.salePercent}% off):</span>
                                        <span className="font-bold">${(selectedProductData.basePrice * (1 - selectedProductData.salePercent / 100)).toFixed(2)}</span>
                                      </div>
                                      <div className="flex justify-between text-green-700">
                                        <span>You Save:</span>
                                        <span className="font-bold">${(selectedProductData.basePrice * (selectedProductData.salePercent / 100)).toFixed(2)}</span>
                                      </div>
                                    </>
                                  )}
                                  {selectedProductData.salePrice && !selectedProductData.salePercent && (
                                    <>
                                      <div className="flex justify-between text-green-700">
                                        ...
                                        <span className="font-bold">${selectedProductData.salePrice.toFixed(2)}</span>
                                      </div>
                                      {selectedProductData.salePrice < selectedProductData.basePrice && (
                                        <div className="flex justify-between text-green-700">
                                          <span>You Save ({Math.round(((selectedProductData.basePrice - selectedProductData.salePrice) / selectedProductData.basePrice) * 100)}% off):</span>
                                          <span className="font-bold">${(selectedProductData.basePrice - selectedProductData.salePrice).toFixed(2)}</span>
                                        </div>
                                      )}
                                    </>
                                  )}
