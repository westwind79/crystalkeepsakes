                  ...
                  <div className="p-6 overflow-y-auto" style={{ maxHeight: '65vh' }}>
                    ...
                    {activeTab === 'basic' && (
                      <div className="space-y-4">
                        ...
                        {/* On Sale Section with Mandatory Sale Price */}
                        <div className="space-y-3">
                          <label className="flex items-center space-x-2">
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                // If unchecking, clear sale price
                                if (!e.target.checked) {
                          ...
                          {selectedProductData.sale && (
                            <div className="ml-6 p-4 bg-red-50 border border-red-200 rounded-lg space-y-3">
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateProduct(selectedProduct.id, { salePrice: parseFloat(e.target.value) || undefined })}
                                ...
                                <div className="mt-2 text-xs text-gray-600 space-y-1">
                                  <div>Original Price: <span className="font-semibold">${selectedProductData.basePrice?.toFixed(2) || '0.00'}</span></div>
                                  {selectedProductData.salePrice && selectedProductData.salePrice < selectedProductData.basePrice && (
                                    <>
                                      <div className="text-green-700">
                                        You Save: <span className="font-semibold">${(selectedProductData.basePrice - selectedProductData.salePrice).toFixed(2)}</span>
                                        {' '}({Math.round(((selectedProductData.basePrice - selectedProductData.salePrice) / selectedProductData.basePrice) * 100)}% off)
                                      </div>
                                    </>
                                  )}
                                  {selectedProductData.salePrice && selectedProductData.salePrice >= selectedProductData.basePrice && (
                                    <div className="text-red-600 font-semibold">⚠️ Sale price must be less than original price!</div>
                                  )}
                                </div>
                              </div>
                            </div>
