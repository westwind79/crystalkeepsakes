...
import { isFeaturedProduct, isLightbaseProduct } from '@/utils/categoriesConfig'
          ...
          <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
            <div className="flex items-start gap-3 flex-wrap">
              ...
              {isFeaturedProduct(product) && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-br from-yellow-400 to-amber-500 text-white rounded-full shadow-md text-sm font-bold uppercase tracking-wide">
                  <svg 
                    className="w-4 h-4" 
                    fill="currentColor" 
                    viewBox="0 0 20 20"
