...
export function Products2() {
  ...
  // Generate fresh data from API - CORRECT endpoint
  const generateFreshData = async () => {
    ...
    try {
      ...
      // Use the correct endpoint that generates the combined products file
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      const module = await import(/* @vite-ignore */ "../data/cockpit3d-products.js?t=" + Date.now());
              ...
              <Alert variant="danger">
                ...
                <div className="d-flex gap-2">
                  ...
                  <Button variant="primary" onClick={generateFreshData} disabled={isGenerating}>
                    {isGenerating ? 'Generating...' : 'Generate Raw Data'}
                  </Button>
                </div>
              </Alert>
            </Col>
